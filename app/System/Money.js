...
const hundreds = (n) => {
    ...
    if (n === 100) {
        ...
        if (decenas === 0) {
            ...
            return val[n - decenas] + " " + tens(decenas);
        }
    } else {
        return tens(n);
    }
...
const thousands = (n) => {
    if (n > 999) {
        ...
        if (c == 1) {
            cadena = 'mil ' + hundreds(x);
        } else if (x != 0) {
            cadena = hundreds(c) + ' mil ' + hundreds(x);
        } else {
            cadena = hundreds(c) + ' mil';
        }
        return cadena;
    }
    return hundreds(n);
...
const millions = (n) => {
    ...
    if (n <= 999999999999) {
        ...
        cadena = thousands(c) + cadena;
        if (x > 0) { cadena = cadena + thousands(x); }
        return cadena;
    }
    return thousands(n);
};

const money_to_string = (n,  plural_currency = "Dolares", singular_currency = "Dolar") => {
...
module.exports = { money_format, money_to_string, strlen, basic, tens, hundreds, thousands, millions };